...
import ModalUpdateChienDich from "./ModalUpdateChienDich";
import { format } from "date-fns";

const ItemDaTao = (props) => {
      ...
      <div className="infor-chien-dich">
        ...
        <div className="right-infor">
          ...
          <div className="action">
            <button onClick={showModalUpdate}>Chỉnh Sửa</button>
